        ...
        <section className='row footer'>
            <Row className="col-md-11 mx-auto">
                ...
                <Col md={6} lg={3} className="fAboutUs">
                    ...
                    <p className="aboutUsDes">xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx</p>
            ...
            <p className="copyRight">Copyright &copy; 2024 <span className="fHighlight">Traidpoint</span>. All rights reserved.</p>
        </section>
    );
};
